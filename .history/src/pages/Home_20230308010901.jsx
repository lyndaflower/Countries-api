      ...
      <div className="w-screen shadow-md py-6 px-3 bg-white dark:bg-gray-700 dark:text-white mb-16">
        <div className="flex container mx-auto">
          ...
          <div className="ml-auto font-medium">
            <button
              onClick={() => darkMode()}
              dangerouslySetInnerHTML={{ __html: iconBtn }}
            />
          </div>
        </div>
      </div>
      <div className="flex container mx-auto mb-16">
        <i className="fa fa-search my-auto -mr-9 z-10 pr-2 pl-3 py-5 rounded-m text-gray-400" />
        <input
        ...
        <select
          ...
          onChange={values => filterByRegion(values.target.value)}
        >
