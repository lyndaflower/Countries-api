    ...
    return (
        <div className="container rounded-lg shadow-lg bg-white dark:bg-gray-700 dark:text-white pb-4">
            ...
            <div className="p-4">
                ...
                <p className="text-xs">Population:<span className="text-gray-700 dark:text-gray-300"> </span></p>
                <p className="text-xs"> Region:<span className="text-gray-700 dark:text-gray-300"> </span></p>
                <p className="text-xs"><span className="text-gray-700 dark:text-gray-300"> </span></p>
